...
{
    { state_moving_up_do   , NULL, NULL, NULL, state_at_floor_entry },
    { state_moving_up_entry, NULL, NULL, NULL, state_at_floor_entry }, 
    { state_moving_up_entry, NULL, NULL, NULL, state_at_floor_entry },
    { state_moving_up_entry, NULL, NULL, NULL, state_at_floor_entry },
    { state_moving_up_entry, NULL, NULL, NULL, state_at_floor_do }
};
